...
public class OrderServiceImpl implements OrderService {
    ...
    public List<Object[]> getAll() {
        ...
        // Result list to store aggregated results
        List<Object[]> result = new ArrayList<>();

        // Loop through the orders and manually aggregate the totals
        for (OrderEntity order : list) {
            boolean found = false;

            // Check if the combination of customerId, orderDate, and status already exists in the result
            ...
            // If the combination doesn't exist, add it as a new entry
            if (!found) {
